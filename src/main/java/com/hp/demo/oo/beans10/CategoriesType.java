 ...
 *       &lt;sequence>
 *         &lt;element name="category" type="{}refIdType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CategoriesType {
    ...
    protected List<RefIdType> category;
     ...
     * 
     */
    public List<RefIdType> getCategory() {
        if (category == null) {
            category = new ArrayList<RefIdType>();
        }
